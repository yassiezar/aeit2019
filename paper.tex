...
\begin{table}
  ...
  \begin{tabular}{p{1cm}p{2cm}p{2.2cm}@{\hskip 1cm}p{3cm}}
    \toprule
...
Interestingly, the elevation errors for group \textit{G2} are centred around the negative angle, indicating a possible underlying bias in the participants or the interface\todo{show}.
